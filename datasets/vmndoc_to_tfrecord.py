...
if __name__ == "__main__":
    ...
    training_data_dir = util.io.join_path(root_dir,'train_data')
    training_gt_dir = util.io.join_path(root_dir,'train_data')
    ...
    test_data_dir = util.io.join_path(root_dir, 'val_data')
    test_gt_dir = util.io.join_path(root_dir,'val_data')
